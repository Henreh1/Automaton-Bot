...
module.exports = {
    ...
    async execute(member, message) {
        ...
        if (!guildData) return;
            ...
            const img = await Canvas.loadImage("https://static.wikia.nocookie.net/helldivers_gamepedia/images/d/dc/Commissar_Enemy_Icon.png/revision/latest?cb=20250223150737");
